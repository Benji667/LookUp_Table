...
<Project Type="Project" LVVersion="17008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Base classes" Type="Folder">
			<Item Name="LUT.lvlib" Type="Library" URL="../../src/LUT.lvlib"/>
		</Item>
		<Item Name="Test cases" Type="Folder">
			<Item Name="LUT - Test create DVR.vi" Type="VI" URL="../LUT - Test create DVR.vi"/>
			<Item Name="LUT - Test destroy DVR.vi" Type="VI" URL="../LUT - Test destroy DVR.vi"/>
			<Item Name="LUT - Test Empty.vi" Type="VI" URL="../LUT - Test Empty.vi"/>
			<Item Name="LUT - Test Get All.vi" Type="VI" URL="../LUT - Test Get All.vi"/>
			<Item Name="LUT - Test Getter.vi" Type="VI" URL="../LUT - Test Getter.vi"/>
			<Item Name="LUT - Test Setter.vi" Type="VI" URL="../LUT - Test Setter.vi"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Run Tests in Active Project.vi" Type="VI" URL="/C/Program Files (x86)/National Instruments/LabVIEW 2017/project/Caraya/Run Tests in Active Project.vi"/>
		</Item>
